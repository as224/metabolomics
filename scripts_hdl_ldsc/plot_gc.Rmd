...
# Without hclust 
pheatmap_plot_woCorrection_withoutHclust <- pheatmap(matrix_corr_sign_ldsc,
                          cluster_rows = FALSE,  
                          cluster_cols = FALSE, 
                          annotation_col = NULL,  # Use column names as annotations at the top
                          border_col = NA,
                          annotation_row = NULL, 
                          fontsize = 7,          # Set fontsize for labels
                          main = "Genetic Correlation Heatmap - corrected gc values and significant p-values (LDSC)", 
                          angle_col = 90,       
                          angle_row = 0,        
...
ggsave(paste(folder_heatmaps_ldsc, "/pheatmap_plot_corr_sign_withoutHclust_ldsc.png", sep=""), plot = pheatmap_plot_woCorrection_withoutHclust, width = 7, height = 7, units = "in", dpi = 300)

# With hclust 
pheatmap_plot_woCorrection_hclust <- pheatmap(matrix_corr_sign_ldsc,
                          cluster_rows = FALSE,  
                          cluster_cols = TRUE, 
                          annotation_col = NULL,  # Use column names as annotations at the top
                          border_col = NA,
                          annotation_row = NULL, 
                          fontsize = 7,          # Set fontsize for labels
                          main = "Genetic Correlation Heatmap - corrected gc values, significant p-values and hclust (LDSC)", 
                          angle_col = 90,       
                          angle_row = 0,        
                          fontsize_row = 5,      # Set fontsize for row labels
                          fontsize_col = 5,      # Set fontsize for column labels
...
ggsave(paste(folder_heatmaps_ldsc, "/pheatmap_plot_corr_sign_hclust_ldsc.png", sep=""), plot = pheatmap_plot_woCorrection_hclust, width = 7, height = 7, units = "in", dpi = 300)
```
...
pheatmap_plot_withoutHclust <- pheatmap(matrix_hdl,
                          ...
                          angle_col = 90,       
                          angle_row = 0,        
                          fontsize_row = 4.5,      # Set fontsize for row labels
                          fontsize_col = 4.5,      # Set fontsize for column labels
                          cellwidth = 4.5,        # Set cell width
                          cellheight = 4.5,       # Set cell height
                          col = my_palette,       # Color scheme
                          breaks = seq(-1, 1, length.out = 101)  # Define breaks from -1 to 1
)
...
pheatmap_plot_woCorrection_withoutHclust <- pheatmap(matrix_corr_sign_hdl,
                          ...
                          annotation_row = NULL, 
                          fontsize = 7,          # Set fontsize for labels
                          main = "Genetic Correlation Heatmap - corrected gc values and significant p-values (HDL)", 
                          angle_col = 90,       
                          angle_row = 0,        
...
pheatmap_plot_woCorrection_hclust <- pheatmap(matrix_corr_sign_hdl,
                          ...
                          annotation_row = NULL, 
                          fontsize = 7,          # Set fontsize for labels
                          main = "Genetic Correlation Heatmap - corrected gc values, significant p-values and hclust (HDL)", 
                          angle_col = 90,       
                          angle_row = 0,        
                          fontsize_row = 6,      # Set fontsize for row labels
                          fontsize_col = 6,      # Set fontsize for column labels
